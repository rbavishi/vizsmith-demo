...
description = 'A HelloWorld custom widget based on the Jupyter documentation'
...
data_files = [
    ('share/jupyter/nbextensions/viz_synthesis_widget', [
        'viz_synthesis_widget/static/extension.js',
        'viz_synthesis_widget/static/index.js',
        'viz_synthesis_widget/static/index.js.map',
    ]),
    ('etc/jupyter/nbconfig/notebook.d', [
        'enable_viz_synthesis_widget.json'
    ])
